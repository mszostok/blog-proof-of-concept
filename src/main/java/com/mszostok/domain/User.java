...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        if (rolesList != null ? !rolesList.equals(user.rolesList) : user.rolesList != null) return false;
        return postList != null ? postList.equals(user.postList) : user.postList == null;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (postList != null ? postList.hashCode() : 0);
